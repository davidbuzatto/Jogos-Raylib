...
#define GAME_WORLD_PALETTE_BUTTON_QUANTITY 24
...
void colorizeBFSFramesStepByStep( GameWorld *gw, Image *img, int x, int y, int positionColor, Color *newColor, int pixelQuantityPerFrame ) ;
